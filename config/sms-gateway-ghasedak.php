...
return [
    ...
    | sent as the "apikey" header on every request. It has no config default, so
    | a missing SMS_GATEWAY_GHASEDAK_API_KEY environment variable fails at
    | driver resolution instead of sending an unauthenticated request.
    |
    */
    ...
    | Base URL
    |--------------------------------------------------------------------------
    | The endpoint the Ghasedak driver sends requests to. This value is the
    | single source of truth for the host: edit it here, or set
    | SMS_GATEWAY_GHASEDAK_BASE_URL, when a proxy or a sandbox environment
    ...
    */
    ...
    'timeout' => [
        'server' => (int) env('SMS_GATEWAY_GHASEDAK_SERVER_TIMEOUT', env('SMS_GATEWAY_SERVER_TIMEOUT', 5)),
        'client' => (int) env('SMS_GATEWAY_GHASEDAK_CLIENT_TIMEOUT', env('SMS_GATEWAY_CLIENT_TIMEOUT', 6)),
    ],
    ...
    */
    ...
    'retry' => [
        'times'              => (int) env('SMS_GATEWAY_GHASEDAK_RETRY_TIMES', env('SMS_GATEWAY_RETRY_TIMES', 2)),
        'sleep_milliseconds' => (int) env('SMS_GATEWAY_GHASEDAK_RETRY_SLEEP_MILLISECONDS', env('SMS_GATEWAY_RETRY_SLEEP_MILLISECONDS', 100)),
    ],
